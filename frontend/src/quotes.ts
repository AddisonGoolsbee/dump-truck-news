export const QUOTES: string[] = [
  ...
  "There’s a secret map hidden in the seams of spare socks.",
  "Conversations with silence are the most revealing.",
  "I whisper plans to the plants; they grow in secret.",
